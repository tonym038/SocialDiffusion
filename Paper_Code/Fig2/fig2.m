...
xlim([0 0.35])
ylim([0 100])
title('Modified Fig2b: Switching Rate \rho_{e} = 0.2, \gamma = 5')
...
xlim([0 0.35])
ylim([0 100])
title('Modified Fig2c: Switching Rate \rho_{e} = 0.6, \gamma = 5')
xlabel('Switching rate, y')
ylabel('Percentage Frequency')